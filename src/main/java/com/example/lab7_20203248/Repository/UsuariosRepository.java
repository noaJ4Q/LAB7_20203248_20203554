...
public interface UsuariosRepository extends JpaRepository<Usuarios, Integer> {
    ...
    void guardar(int id, String nombre, String apellido, String correo, String username, String password, String estado_logico, int rol_id, Instant fecha_registro);
}
